    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b">
        <div className="container mx-auto max-w-5xl px-4 sm:px-6 py-6 md:py-10">
          <Link
            to="/Help"
            className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-4 md:mb-6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md px-1 -mx-1"
          >
      ...
      <section className="container mx-auto max-w-5xl px-4 sm:px-6 py-6 md:py-8">
        <div className="relative">
          ...
          <input
            ...
            aria-label="Search account articles"
            placeholder="Search account articles..."
            className="w-full rounded-xl border bg-background pl-11 pr-4 py-3 outline-none focus-visible:ring-2 focus-visible:ring-primary text-sm md:text-base transition-shadow"
          />
        </div>
      </section>
        ...
        <div className="grid gap-4 md:gap-6 sm:grid-cols-2">
          {articles.map((article) => (
            <Link
              key={article.title}
              to="#"
              className="group flex flex-col justify-between rounded-2xl border p-5 hover:shadow-md transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            >
              <div>
